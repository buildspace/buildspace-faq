...
<span>This happens because there's a dependency that's not included in the hardhat version.</span>
...
<span>
    This happens because your smart contract is in a nested folder which can be a problem for VS Code Solidity extension when they're trying
    to look for a package that you're trying to import from the node_modules.
</span>
